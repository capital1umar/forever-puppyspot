...
const Product = () => {
  ...
  const { Produc, currency, addToCart } = useContext(ShopContext);
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            ...
            <p>
              Cash on delivery is available for these products after
              transferring a partial payment
            </p>
